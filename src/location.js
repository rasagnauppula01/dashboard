...
const [selectedLocations, setSelectedLocations] = useState([]);
  ...
  const currentUsers = cloneUsers.slice(indexOfFirstUser, indexOfLastUser); // Use cloneUsers for pagination
...
//     const filteredUsers = cloneUsers.filter((user) =>
//       selectedList.includes(user.location_name)
//     );
